...
<head>
  ...
  <script>
    $(function(){
      initIndex();
      var tabObj = $.tab({
        fixTabItems:[{"tabId":"000","tabText":"系统主页","iframeUrl":"...."}]
      });
    });
  </script>
</head>
<body style="padding-top:41px">
  ...
  <div id="tabArea">
    ...
    <!--tab左移按钮-->
    <div id="menu-ctrl-left"><a href="javascript:void(0)" id="tab-left-btn">
    ...
    <!--tab右移按钮-->
    <div id="menu-ctrl-right"><a href="javascript:void(0)" id="tab-right-btn">
